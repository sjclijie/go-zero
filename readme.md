...
[![Go](https://github.com/sjclijie/go-zero/workflows/Go/badge.svg?branch=master)](https://github.com/sjclijie/go-zero/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/sjclijie/go-zero)](https://goreportcard.com/report/github.com/sjclijie/go-zero)
[![goproxy](https://goproxy.cn/stats/github.com/sjclijie/go-zero/badges/download-count.svg)](https://goproxy.cn/stats/github.com/sjclijie/go-zero/badges/download-count.svg)
[![codecov](https://codecov.io/gh/sjclijie/go-zero/branch/master/graph/badge.svg)](https://codecov.io/gh/sjclijie/go-zero)
[![Release](https://img.shields.io/github/v/release/sjclijie/go-zero.svg?style=flat-square)](https://github.com/sjclijie/go-zero)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/sjclijie/go-zero
```
...
0. 完整示例请查看
    ...
    [快速构建高并发微服务](https://github.com/sjclijie/zero-doc/blob/main/doc/shorturl.md)

    [快速构建高并发微服务 - 多 RPC 版](https://github.com/sjclijie/zero-doc/blob/main/docs/zero/bookstore.md)
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/sjclijie/go-zero/tools/goctl
    ```
...
2. 快速生成 api 服务
    ...
    编写业务代码：
      ...
      * api 文件定义了服务对外暴露的路由，可参考 [api 规范](https://github.com/sjclijie/zero-doc/blob/main/doc/goctl.md)
...
* API 文档
  ...
  [https://www.yuque.com/sjclijie/go-zero](https://www.yuque.com/sjclijie/go-zero)

* awesome 系列（更多文章见『微服务实践』公众号）
  * [快速构建高并发微服务](https://github.com/sjclijie/zero-doc/blob/main/doc/shorturl.md)
  * [快速构建高并发微服务 - 多 RPC 版](https://github.com/sjclijie/zero-doc/blob/main/docs/zero/bookstore.md)
  * [goctl 使用帮助](https://github.com/sjclijie/zero-doc/blob/main/doc/goctl.md)
