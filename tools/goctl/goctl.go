...
import (
	...
	"github.com/sjclijie/go-zero/tools/goctl/api/apigen"
	"github.com/sjclijie/go-zero/tools/goctl/api/dartgen"
	"github.com/sjclijie/go-zero/tools/goctl/api/docgen"
	"github.com/sjclijie/go-zero/tools/goctl/api/format"
	"github.com/sjclijie/go-zero/tools/goctl/api/gogen"
	"github.com/sjclijie/go-zero/tools/goctl/api/javagen"
	"github.com/sjclijie/go-zero/tools/goctl/api/ktgen"
	"github.com/sjclijie/go-zero/tools/goctl/api/new"
	"github.com/sjclijie/go-zero/tools/goctl/api/tsgen"
	"github.com/sjclijie/go-zero/tools/goctl/api/validate"
	"github.com/sjclijie/go-zero/tools/goctl/configgen"
	"github.com/sjclijie/go-zero/tools/goctl/docker"
	"github.com/sjclijie/go-zero/tools/goctl/kube"
	model "github.com/sjclijie/go-zero/tools/goctl/model/sql/command"
	"github.com/sjclijie/go-zero/tools/goctl/plugin"
	rpc "github.com/sjclijie/go-zero/tools/goctl/rpc/cli"
	"github.com/sjclijie/go-zero/tools/goctl/tpl"
	"github.com/sjclijie/go-zero/tools/goctl/upgrade"
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "style",
							Usage: "the file naming format, see [https://github.com/sjclijie/go-zero/tree/master/tools/goctl/config/readme.md]",
						},
					},
